...
@section('content')
    <section class="my-5">
        <div class="container">
            <a href="{{ route('user.event.upcoming', ['id' => auth()->user()->id]) }}"
                class="font-light-blue mb-4 d-block"><i class="bi bi-arrow-left mr-1"></i> Back to
                My Events</a>
            <h1 class="mb-4">Detail Transaction</h1>
                                ...
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select type='text' class="form-select" id='selectTime' disabled>
                                            </select>
                                        </div>
                                    </div>
                                </div>
